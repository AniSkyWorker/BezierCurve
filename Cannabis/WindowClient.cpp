...
const float LINE_LENGTH = 1.f;
const size_t VERTICIES = size_t(LINE_LENGTH * 500.f * M_PI);
...
CWindowClient::CWindowClient(CWindow &window)
    ...
    , m_pointsObj(LINE_LENGTH, VERTICIES)
    ...
    , m_programFixed(CShaderProgram::fixed_pipeline_t())
{
    ...
    const std::string twistShader = CFilesystemUtils::LoadFileAsString("Kannabola.vert");
